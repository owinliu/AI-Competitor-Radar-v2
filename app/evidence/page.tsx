...
export default function AppVersionUpdatesPage() {
  ...
  const bossConclusions = [
    "主打信息层面，五家产品均持续强调“高额度+低门槛+快审批/快放款”核心借贷卖点。",
    "更新日志与截图文案共同显示：活动类表达（如优惠、免息、福利、主题活动）仍是高频运营抓手。",
    "从应用市场截图文案看，多数产品保持主框架稳定，变化主要集中在首屏主视觉与活动文案替换。",
  ];

  const diffSummary = [
    "分期乐：主打“分期借钱+分期购物”，截图与文案侧重借贷与消费双场景导流。",
    "度小满：文案持续突出“最高额度200000、年化利率7.29%起”，并出现主题活动型海报表达。",
    "安逸花：主打“正规持牌+快速放款+申请便捷”，截图文案以稳态转化信息为主。",
    "奇富借条：文案持续强调“额度最高20万、3步申请、30天免息”，活动利益点表达稳定延续。",
    "小赢：持续突出“美股上市公司、最高额度200000、线上申请、最快5分钟审批”等效率型卖点。",
  ];
