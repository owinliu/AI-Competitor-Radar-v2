export default function WebGlobalSearchPage() {
  ...
  return (
    <div className="space-y-4">
      <section className="rounded-xl border border-[#e5edf5] bg-white px-5 py-4">
        <h1 className="text-2xl font-semibold text-[#061b31]">全局分析</h1>
      ...
      <div className="h-[calc(100vh-13rem)] w-full overflow-hidden rounded-xl border border-[#e5edf5] bg-white">
        <iframe
          title="消费信贷平台竞品分析报告"
